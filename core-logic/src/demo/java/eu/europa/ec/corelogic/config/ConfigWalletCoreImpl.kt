...
internal class WalletCoreConfigImpl(
    ...
    private companion object {
        const val VCI_ISSUER_URL = "https://poc-issuer.g-trustedweb.workers.dev"
        const val VCI_CLIENT_ID = "tw24.wallet.dentsusoken.com"
        ...
        get() {
            if (_config == null) {
                _config = EudiWalletConfig {
                    ...
                    configureOpenId4Vp {  
                        withEncryptionAlgorithms(listOf(
                    ...
                    configureReaderTrustStore(context, R.raw.trusted_web_verifier)
                }
            }
            return _config!!
        }
